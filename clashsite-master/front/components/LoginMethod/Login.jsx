  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (token) {
        ...
        setUserInputs({ email: "", password: "", provider: "" });
        navigate("/profile");
      }
    } catch (err) {
      console.log(err);
          ...
          <div className="grid items-center gap-10 lg:grid-cols-[1.05fr,0.95fr]">
            <section className="hidden lg:flex flex-col gap-6 rounded-3xl border border-white/10 bg-white/10 p-10 shadow-2xl backdrop-blur-xl">
              ...
              <p className="text-white/80">
                Jump back into your profile, track donations, and connect with
                your clan from any device. The refreshed layout adapts
                seamlessly to phones, tablets, and desktops.
              </p>
              <ul className="mt-4 space-y-4 text-sm text-white/80">
                ...
                <li className="flex items-center gap-3">
                  ...
                  <span>
                    Streamlined form built for touch and keyboard use.
                  </span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="flex h-9 w-9 items-center justify-center rounded-full bg-amber-500/15 text-amber-300">
                  ...
                  <span>
                    Save progress securely and continue where you left off.
                  </span>
                </li>
              </ul>
            </section>
            ...
            <div className="rounded-3xl border border-white/10 bg-black/70 p-8 shadow-2xl backdrop-blur-xl sm:p-10">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="mt-2 text-sm text-white/70">
                  Sign in to manage your clan, track progress, and sync across
                  every device.
                </p>
              </div>
